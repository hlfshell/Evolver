...
module.exports = function(){
  ...
  var FunctionalNode = function(fnc, name, terminal, minParams, maxParams){
    ...
    this.maxParams = maxParams === undefined ? this.minParams : this.maxParams
  ...
  FunctionalNode.prototype.execute = function(params, cb){
    ...
    if(self.terminal){
      ...
      async.eachSeries(self.params, function(param, done){
        setImmediate(param.execute(params, function(result){
    ...
    if(self.id == id){
      ...
      async.whilst(function(){
        ...
        setImmediate(function(){
          self.params[paramCount].getChildById(id, function(child){
            if(child){
              foundNode = child
            }
            paramCount++
  ...
  FunctionalNode.prototype.getParentByChildId = function(id, cb){
    ...
    async.whilst(function(){
      ...
      if(!self.params[paramCount].terminal){
        setImmediate(self.params[paramCount].getParentByChildId(id, function(parent){
          if(parent){
            found = parent
            done(null)
          }
