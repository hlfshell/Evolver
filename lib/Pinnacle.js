...
module.exports = function(){
  ...
  pinnacle.prototype.getFitness = function(cb){
    var self = this
    if(typeof self.trainingSet == 'array'){
      self._next(function(){
        if(self.gibbsSampleTrainingSet){
          self._next(function(){
            self.gibbsSamplingFitness(function(significantSet){
              self._next(function(){
                cb(significantSet)
              })
            })
  ...
  //sampling
  pinnacle.prototype.gibbsSampling = function(collection, cb){
